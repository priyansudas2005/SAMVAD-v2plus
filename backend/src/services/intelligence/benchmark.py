...
class MeetingIntelligenceBenchmarker:
    ...
    @staticmethod
    def run_benchmark(
        meeting_id: str, start_time: float, num_segments: int, report: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        benchmark_data = {
            ...
            "latency": {
                ...
                "latency_per_segment_ms": round(
                    (elapsed / num_segments * 1000) if num_segments > 0 else 0.0, 2
                ),
            },
            "metrics": {
