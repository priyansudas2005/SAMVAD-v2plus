    ...
    <div className={`flex-1 flex flex-col h-screen overflow-hidden bg-transparent relative p-5 transition-all duration-500 ${uploading ? 'blur-[3px] pointer-events-none' : ''}`}>
      ...
      <div className="flex-1 grid grid-cols-12 gap-7 min-h-0 overflow-hidden pb-2 px-1 mb-24">
        ...
        <aside
          ...
          className="col-span-12 lg:col-span-3 bg-slate-950/80 border border-white/[0.06] premium-card-interaction rounded-2xl p-5 flex flex-col gap-3.5 overflow-y-auto h-full backdrop-blur-2xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] scrollbar-none select-none pb-24"
        >
          <div>
        ...
        <main
          onMouseMove={handleMouseMove}
          className="col-span-12 lg:col-span-6 flex flex-col h-full bg-slate-950/50 border border-white/[0.04] premium-card-interaction rounded-2xl p-6 relative overflow-y-auto backdrop-blur-xl shadow-[0_30px_70px_rgba(0,0,0,0.85)] gap-5 pb-28"
        >
          {/* Subtle mesh grid */}
        ...
        <aside
          onMouseMove={handleMouseMove}
          className="col-span-12 lg:col-span-3 bg-slate-950/75 border border-white/[0.05] premium-card-interaction rounded-2xl p-4 flex flex-col gap-3 overflow-y-auto h-full backdrop-blur-2xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] select-none pb-24 scrollbar-none"
        >
          <div>
